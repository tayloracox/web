    ...
    <div className="wrap">
      ...
      <div className="quote-wrap">
        ...
        <div className="quote-box">
          <p>
            "This was one of the most intimidating, exhausting, and stressful challenges I have ever taken on and I
            would not change my decision to attend for anything. This gave me a home away from home, it became
            a sanctuary where people of similar mind would share ideas and learn from each other."
          </p>
      ...
      <p className="cta">
        <a href="http://gallery-gift-card.caleb.surge.sh/" target="_blank">Read More of our Success Stories</a>
      </p>
    </div>
  </div>
)
